...
public static class ModelBuilderExtensions
{
    ...
    public static void SeedAccounts(this ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>().HasData(
            new Account { Id = 1, UserId = 1, CreationDate = DateTime.Now, IsBlocked = false, Money = 10000.00 },
            new Account { Id = 2, UserId = 2, CreationDate = DateTime.Now, IsBlocked = false, Money = 20000.00 },
            new Account { Id = 3, UserId = 1, CreationDate = DateTime.Now, IsBlocked = false, Money = 5000.00 },
            new Account { Id = 4, UserId = 2, CreationDate = DateTime.Now, IsBlocked = false, Money = 2000.00 }
            );
    }
